...
function preload(){
    ...
    redkeyImg = loadImage("redkey.png");
    redImg = loadImage("redl.png");
    blukeyImg = loadImage("blukey.png");
    blueImg = loadImage("blul.png");
    yellowkeyImg = loadImage("yelokey.png");
    yellowImg = loadImage("yelol.png");
}
function setup(){
    ...
    redlock = createSprite(345,190,20,20);
    ...
    bluelock = createSprite(460,505,20,20);
    ...
    yellowlock = createSprite(398,670,20,20);
    yellowlock.addImage(yellowImg);
    yellowlock.scale = 0.2;
